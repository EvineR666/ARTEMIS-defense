...
show_progress = False
use_img_style_transfer = True  # 是否使用图像域迁移
...
class params(object):
    def __init__(self):
        # print(os.getcwd())
        self.style_dir = os.getcwd() + '/utils/input/style/S_image1.jpg'
        self.vgg = os.getcwd() + '/utils/experiments/vgg_normalised.pth'
        self.decoder_path = os.getcwd() + '/utils/experiments/decoder_iter_160000.pth'
        self.Trans_path = os.getcwd() + '/utils/experiments/transformer_iter_160000.pth'
        self.embedding_path = os.getcwd() + '/utils/experiments/embedding_iter_160000.pth'
        if "Users" in os.getcwd():  # 在windows本机用pycharm进行debug的话
            self.style_dir = os.getcwd() + '/../utils/input/style/S_image1.jpg'
            self.vgg = os.getcwd() + '/../utils/experiments/vgg_normalised.pth'
            self.decoder_path = os.getcwd() + '/../utils/experiments/decoder_iter_160000.pth'
            self.Trans_path = os.getcwd() + '/../utils/experiments/transformer_iter_160000.pth'
...
class ModelTrainerCLS_v2():
    ...
    def one_forward_backward(self, x, labels, device, verbose=0):
        ...
        with torch.cuda.amp.autocast(enabled=self.amp):
            ...
            pred_clean1, mid_output1 = self.model.get_mid_forward(x1)   # forward的输出都是相等的
            pred_clean, predt1 = pred_clean1.chunk(2, dim=0)
            nwd1 = self.model.use_mid_nwdforward(mid_output1)
            ...
            # print(f"discrepancy_loss0: {discrepancy_loss0}")
            # print(f"discrepancy_loss1: {discrepancy_loss1}")
