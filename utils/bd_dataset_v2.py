...
class poisonedCLSDataContainer:
    ...
    def __getitem__(self, key):
        if self.save_folder_path is None:
            ...
            # file_path = "../BackdoorBench/" + file_path[file_path.index("record"):]
            file_path = "../" + file_path[file_path.index("record"):]
            # file_path = "../BackdoorBench/record/wanet_attack_cifar100/" + file_path[file_path.index("bd_test_dataset"):]
